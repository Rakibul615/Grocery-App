        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-sm-6 col-sm-6">
                    <div class="feature-card-alpha">
                        <div class="feature-icon">
                            <img src="{{asset('/')}}website/assets/images/icons/feature-i1.svg" alt>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="feature-card-alpha">
                        <div class="feature-icon">
                            <img src="{{asset('/')}}website/assets/images/icons/feature-i2.svg" alt>
                        </div>
                        <div class="feature-content">
                            <h5>24/7 Supports</h5>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="feature-card-alpha">
                        <div class="feature-icon">
                            <img src="{{asset('/')}}website/assets/images/icons/feature-i3.svg" alt>
                        </div>
                        <div class="feature-content">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="feature-card-alpha">
                        <div class="feature-icon">
                            <img src="{{asset('/')}}website/assets/images/icons/feature-i4.svg" alt>
                        </div>
                        <div class="feature-content">
